import org.himanshu.model.account.Contact;
import org.himanshu.model.account.LicenseInfo;
...
import org.himanshu.model.vehicle.*;
...
public class TestData {
    ...
    public static HireableVehicle getTruck(){
        ...
        truck.setId(id);
        truck.setLicensePlateNumber("KA 05 MA 8390");
        truck.setQrCode(id);
        truck.setMake("Mahindra");
        truck.setModel("XUV 700");
        truck.setYearOfManufacture(2021);
        truck.setNumberOfSeats(7);
        truck.setMileage(22000);
        truck.setVehicleCategory(VehicleCategory.PASSENGER);
        truck.setVehicleStatus(VehicleStatus.AVAILABLE);
    ...
    public static HireableVehicle getHatchBack() {
        ...
        String id = UUID.randomUUID().toString();
        car.setId(id);
        car.setLicensePlateNumber("KA 51 CA 8344");
        car.setQrCode(id);
        car.setMake("Hyundai");
        car.setMake("i20");
    ...
    public static HireableVehicle getMarutiHatchBack() {
        ...
        String id = UUID.randomUUID().toString();
        car.setId(id);
        car.setLicensePlateNumber("KA 02 CA 7416");
        car.setQrCode(id);
        car.setMake("Maruti");
        car.setModel("Swift");
    ...
    public static HireableVehicle getSuvCar() {
        ...
        String id = UUID.randomUUID().toString();
        car.setId(id);
        car.setLicensePlateNumber("KA 01 AA 4561");
        car.setQrCode(id);
        car.setMake("TATA");
        car.setMake("Harrier");
    ...
    public static Chauffer getChauffeur() {
        AddonService addonService = new Chauffer();
        ...
        return ((Chauffer) addonService);
    }

    public static LicenseInfo getLicenseInfo() {
        LicenseInfo licenseInfo = new LicenseInfo();
        licenseInfo.setLicenseNumber("ka051023098290");
        ...
        licenseInfo.setIssuedAtState("Karnataka");
